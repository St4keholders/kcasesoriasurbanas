...
export function CajaMenorClientView({ boxes }: { boxes: any[] }) {
  ...
  return (
    <>
      <AdminTopbar 
        ...
        action={
          <Link href="/admin/caja-menor/nueva" className="neu-btn-primary py-1.5 px-3 text-sm flex items-center gap-2">
